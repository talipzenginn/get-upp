...
const kConfirmColor = Colors.red;
const kNotConfirmColor = Colors.blue;
const kDeleteButtonColor = Colors.red;
final kEditDismissBackground = Colors.green[400];
final kDeleteDismissBackground = Colors.red;
