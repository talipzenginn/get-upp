...
class ActiveColorProvider extends ChangeNotifier{
  ...
  void changeLessButtonColor(){
    lessButtonColor = lessButtonColor == kLessButtonActiveColor?kInactiveColor:kLessButtonActiveColor;
    middleButtonColor = kInactiveColor;
    moreButtonColor = kInactiveColor;
    notifyListeners();
  }
  void changeMiddleButtonColor(){
    middleButtonColor = middleButtonColor == kMiddleButtonActiveColor?kInactiveColor:kMiddleButtonActiveColor;
    lessButtonColor = kInactiveColor;
    moreButtonColor = kInactiveColor;
    notifyListeners();
  }
  void changeMoreButtonColor(){
    moreButtonColor = moreButtonColor == kMoreButtonActiveColor?kInactiveColor:kMoreButtonActiveColor;
    lessButtonColor = kInactiveColor;
    middleButtonColor = kInactiveColor;
    notifyListeners();
  }
